...
export default function AboutPage() {
  ...
  const isBiographyRefInView = useInView(biographyRef, { once: true })
  ...
  return (
    ...
    >
      ...
      >
        {/* TEXT CONTAINER */}
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-40 flex flex-col 
        gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2'>
          {/* BIOGRAPHY */}
          <div className='flex justify-center items-center' ref={biographyRef}>
            <motion.div
              className='flex flex-col gap-12 justify-center items-center'
              initial={{ x: 0 }}
              animate={isBiographyRefInView ? { x: 0 } : { x: '-100vw' }}
              ...
              <p className='text-lg'>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magni nesciunt culpa ipsa consectetur ducimus eveniet voluptatum nobis exercitationem, accusamus cumque, provident maxime ullam assumenda eius corrupti! Ut maxime consequatur quo.</p>
            ...
            >
              <div className='flex justify-between h-fit'>
                <div className='w-5/12'>
                  ...
                  rounded-b-lg rounded-s-lg'>Senior JS Engineer</div>
                  ...
                  <div className='px-3 py-1 rounded bg-white text-sm font-semibold w-fit'>Apple</div>
                </div>

                <div className='w-1/6'>
                  <div className='w-1 left-1/2 h-full bg-gray-600 rounded relative'>
              ...
              <div className='flex justify-between h-fit'>
                ...
                <div className='w-5/12'>
                  ...
                  <div className='p-3 text-sm italic'>My current employment. Way better than the position before</div>
                  <div className='p-3 text-red-400 text-sm font-semibold'>2024 - Present</div>
                  <div className='px-3 py-1 rounded bg-white text-sm font-semibold w-fit'>Apple</div></div>
              </div>
